...
namespace basecross {
	...
	void GameStage11::OnCreate() {
		...
		//最後にプレイしたステージを渡す
		App::GetApp()->GetScene<Scene>()->SetLastPlayStage(11);
	...
	//アイテム生成
	void GameStage11::CreateBattery()
	{
		vector<Vec3> posVec =
		{
	...
	//敵がどれくらい追いかけてくるか確認する
	int GameStage11::GameEnemyState()
	{
	...
	void GameStage11::OutWallCreate(int selLength)//←個々の引数はこのマップの直径はブロック何個ぶんかを聞いています
	{
	...
	void GameStage11::SetEnemy(int num)
	{
		EnemyNow -= num;
	}
}
