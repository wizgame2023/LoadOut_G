...
namespace basecross {
	const std::map<std::wstring, Vec3> happysky::pairs = {
		{ L"000_000_000", Vec3(0  ,0.45f,  +0.5f) },
		{ L"000_090_000", Vec3(+0.5f, 0.45f, 0  ) },
		{ L"000_180_000", Vec3(0  ,0.45f,  -0.5f) },
		{ L"000_270_000", Vec3(-0.5f, 0.45f, 0  ) },
		{ L"090_000_000", Vec3(0  ,-0.0f,0  ) },
		{ L"270_000_000", Vec3(0  ,+0.95f,0  ) }
	};
