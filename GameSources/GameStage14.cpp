...
namespace basecross {
	...
	//	ゲームステージクラス実体
	//--------------------------------------------------------------------------------------
	void GameStage14::CreateViewLight() {
	...
	void GameStage14::OnCreate() {
		...
		//最後にプレイしたステージを渡す
		App::GetApp()->GetScene<Scene>()->SetLastPlayStage(14);
	...
	void GameStage14::OnUpdate()
	{
	}

	//Player生成
	void GameStage14::CreatePlayer()
	{
	...
	//アイテム生成
	void GameStage14::CreateBattery()
	{
		vector<Vec3> posVec =
		{
	...
	//敵がどれくらい追いかけてくるか確認する
	int GameStage14::GameEnemyState()
	{
	...
	void GameStage14::OutWallCreate(int selLength)//←個々の引数はこのマップの直径はブロック何個ぶんかを聞いています
	{
	...
	void GameStage14::SetEnemy(int num)
	{
		EnemyNow -= num;
	}
}
